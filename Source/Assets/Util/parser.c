...
double te_eval(const te_expr *n) {
    ...
    switch(TYPE_MASK(n->type)) {
        ...
        case TE_FUNCTION4: case TE_FUNCTION5: case TE_FUNCTION6: case TE_FUNCTION7:
            switch(ARITY(n->type)) {
                ...
                case 1:
                    return n->v.f.f1(M(0));
                case 2:
                    return n->v.f.f2(M(0), M(1));
                case 3:
                    return n->v.f.f3(M(0), M(1), M(2));
                case 4:
                    return n->v.f.f4(M(0), M(1), M(2), M(3));
                case 5:
                    return n->v.f.f5(M(0), M(1), M(2), M(3), M(4));
                case 6:
                    return n->v.f.f6(M(0), M(1), M(2), M(3), M(4), M(5));
                case 7:
                    return n->v.f.f7(M(0), M(1), M(2), M(3), M(4), M(5), M(6));
                default: return NAN;
            }
        ...
        case TE_CLOSURE4: case TE_CLOSURE5: case TE_CLOSURE6: case TE_CLOSURE7:
            switch(ARITY(n->type)) {
                case 0:
                    return n->v.f.cl0(n->parameters[0]);
                case 1:
                    return n->v.f.cl1(n->parameters[1], M(0));
                case 2:
                    return n->v.f.cl2(n->parameters[2], M(0), M(1));
                case 3:
                    return n->v.f.cl3(n->parameters[3], M(0), M(1), M(2));
                case 4:
                    return n->v.f.cl4(n->parameters[4], M(0), M(1), M(2), M(3));
                case 5:
                    return n->v.f.cl5(n->parameters[5], M(0), M(1), M(2), M(3), M(4));
                case 6:
                    return n->v.f.cl6(n->parameters[6], M(0), M(1), M(2), M(3), M(4), M(5));
                case 7:
                    return n->v.f.cl7(n->parameters[7], M(0), M(1), M(2), M(3), M(4), M(5), M(6));
                default: return NAN;
            }
