#include "../../Library/Optimization Algorithms/simpleMaxMinFinderAlgorithm.h"
...
int main() {
    ...
    char a[ASL_INPUT_SIZE], b[ASL_INPUT_SIZE], n_c[ASL_INPUT_SIZE], tryAgain_c[ASL_INPUT_SIZE];
    char *ptr;
    int n = 0, tryAgain = 0;
    double a0, b0;
