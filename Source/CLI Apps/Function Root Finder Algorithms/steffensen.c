...
#include "../../Library/Function Root Finder Algorithms/steffensenAlgorithm.h"
...
int main() {
    ...
    char x0_c[ASL_INPUT_SIZE], ete_c[ASL_INPUT_SIZE], ere_c[ASL_INPUT_SIZE],
            tol_c[ASL_INPUT_SIZE], maxiter_c[ASL_INPUT_SIZE], verbose_c[ASL_INPUT_SIZE], tryAgain_c[ASL_INPUT_SIZE];
    char *ptr;
    ...
    // calculation
    double x = asl_steffenson_root(expression, x0, ete, ere, tol, (unsigned int) maxiter, verbose, &flag);
