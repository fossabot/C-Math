...
int main() {
    ...
    char a[ASL_INPUT_SIZE], b[ASL_INPUT_SIZE], ete_c[ASL_INPUT_SIZE], ere_c[ASL_INPUT_SIZE], tol_c[ASL_INPUT_SIZE],
            maxiter_c[ASL_INPUT_SIZE], verbose_c[ASL_INPUT_SIZE], tryAgain_c[ASL_INPUT_SIZE];
    char *ptr;
    ...
    // calculation
    double x = asl_secant_root(expression, a0, b0, ete, ere, tol, (unsigned int) maxiter, verbose, &flag);
